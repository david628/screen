class Earth {
		...
		if(!this.sphere) {
	      ...
	      new THREE.MeshLambertMaterial({
	        ...
	        //depthWrite: false,
	      	...
	      	color: 0x48EAB6,
	        opacity: 0.7,
	        //map: new THREE.ImageUtils.loadTexture('js/webGL/images/a.jpg'),
	        //map: new THREE.ImageUtils.loadTexture('js/webGL/images/earth_lights.gif'),
	        //map: new THREE.ImageUtils.loadTexture('js/webGL/images/earth_light.jpg'),
    ...
    light0.position.set(-.5, 1, 2).normalize();
  	...
  	var light1 = new THREE.PointLight(0xD0FDFF, 1.2, 0);
  	light1.position.set(0, 0, 600);
  	//light1.lookAt(0, 0, 0);
  	this.scene.add(light1);
		
		var light2 = new THREE.DirectionalLight(0x7efaff, 0.5);
		light2.position.set(400, 400, 100);
		this.scene.add(light2);
		
		/*var light3 = new THREE.PointLight(0x7efaff, 5, 0);
		light3.position.set(0, 0, -200);
		light3.lookAt(0, 0, -500);
		this.scene.add(light3);
		
		var light4 = new THREE.PointLight(0x7efaff, 5, 0);
  ...
  onMouseWheel(event) {
	...
	makeConnectionLineGeometry(start, end, value, type) {
  	...
  	size = this.constrain(size, 30, 60);
	...
	getVisualizedMesh(bin, countries, exportCategories, importCategories) {
  	...
  	var particleGraphic = THREE.ImageUtils.loadTexture("js/webGL/images/particleA.png");
