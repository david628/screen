...
import img_particleA from './assets/images/particleA.png';
  ...
  addSphere() {
    this.sphere = new THREE.Mesh(
      ...
      new THREE.MeshLambertMaterial({
        //map: new THREE.ImageUtils.loadTexture("../assets/images/earth.jpg"),
        //map: new THREE.ImageUtils.loadTexture("../assets/images/earth_political_alpha.png"),   
        //map: new THREE.ImageUtils.loadTexture("../assets/images/fire4.png"),   
        //map: new THREE.ImageUtils.loadTexture("../assets/images/map.png"),
...
//    }
  ...
  addSkyBox() {
    var cube = new THREE.Mesh(
      ...
      new THREE.MeshBasicMaterial({
        color: this.bgColor,
        //color: 0x6FD5F0,
        //map: THREE.ImageUtils.loadTexture("../assets/images/universe.jpg"),
        map: THREE.ImageUtils.loadTexture(img_universe),
        //map: THREE.ImageUtils.loadTexture("../assets/images/bg.png"),
        side: THREE.BackSide,
        opacity: 1.0,
        transparent: true,
        blending: THREE.AdditiveBlending
  ...
  addRing() {
    ...
    var material = new THREE.MeshBasicMaterial({
      //map: THREE.ImageUtils.loadTexture("../assets/images/radial_layers_medium.jpg"),
    ...
    this.scene.add(new THREE.ParticleSystem(geo, new THREE.ShaderMaterial({
      uniforms: {
        ...
        texture: {
          type: "t",
          value: 0,
          texture: THREE.ImageUtils.loadTexture("../assets/images/map_mask.png")
        }
      },
      vertexShader: `
  ...
  addMap() {
    var img0 = new Image();
    //img0.src = "../assets/images/map_inverted.png";
  ...
  showEarth(img) {
    ...
    var uniforms = {
      ...
      texture: {
        type: "t",
        value: 0,
        texture: THREE.ImageUtils.loadTexture("../assets/images/sun_far_128.jpg")
      }*/
    };
...
lineType = 2;
    ...
    var uniforms = {
      ...
      texture: {
        type: "t",
        value: 0,
        //texture: THREE.ImageUtils.loadTexture("../assets/images/particleA.png")
...
"type": this.getTestNumber(0, 3)
  ...
  addHotspot(cs) {  
    ...
    var vec = this.getVector3(cs["lat"], cs["lon"], this.radius);
    vec["name"] = cs["name"];
    this.addMarker(vec);
  }
  _addHotspot(cs) {
      ...
      for(var i = 0; i < cs.length; i++) {
        ...
        var points = new THREE.ParticleSystem(linesGeo, new THREE.ShaderMaterial({
          uniforms: {
            ...
            texture: {
              type: "t",
              //value: THREE.ImageUtils.loadTexture('../assets/images/particleA.jpg')
              value: THREE.ImageUtils.loadTexture(img_particleA)
            }
          },
          vertexShader: `
            //attribute float size;
      ...
      /*for(var i = 0; i < cs.length; i++) {
        ...
        var mat = new THREE.ShaderMaterial({
          uniforms: {
            ...
            texture: {
              type: "t",
              value: THREE.ImageUtils.loadTexture('../assets/images/particleA.png')
            }
          },
          color: 0x000000,
          vertexShader: `
